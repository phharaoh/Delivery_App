        ...
        return Padding(
          ...
          child: Column(
            children: [
              ...
              CustomListTile(title: 'Subtotal', trailingText: cardController.subTotal.toString()),
              CustomListTile(title: 'Delivery Fee', trailingText: '20.00'),
              CustomListTile(title: 'Taxes', trailingText: '15.00'),
              CustomListTile(title: 'Total', trailingText: cardController.total.toString()),
              Spacer(),
              CustomCheckOutBtn(),
            ],
          ),
